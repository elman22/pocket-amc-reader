...
public final class Movies implements BaseColumns {
    ...
    public static final SettingsListField[] availableListFields = {
            new SettingsListField(Movies.CHECKED, R.string.details_checked_label),
            new SettingsListField(Movies.FORMATTED_TITLE, R.string.details_formattedtitle_label),
            new SettingsListField(Movies.RATING, R.string.details_rating_label),
            new SettingsListField(Movies.USER_RATING, R.string.details_userrating_label),
            new SettingsListField(Movies.DIRECTOR, R.string.details_director_label),
            new SettingsListField(Movies.CATEGORY, R.string.details_category_label),
            new SettingsListField(Movies.MEDIA_LABEL, R.string.details_medialabel_label),
            new SettingsListField(Movies.COUNTRY, R.string.details_country_label),
            new SettingsListField(Movies.LENGTH, R.string.details_length_label),
            new SettingsListField(Movies.YEAR, R.string.details_year_label),
            new SettingsListField(Movies.CERTIFICATION, R.string.details_certification_label),
            new SettingsListField(Movies.COLOR_TAG, R.string.details_colortag_label),
            new SettingsListField(Movies.PRODUCER, R.string.details_producer_label),
            new SettingsListField(Movies.WRITER, R.string.details_writer_label),
            new SettingsListField(Movies.COMPOSER, R.string.details_composer_label),
            new SettingsListField(Movies.BORROWER, R.string.details_borrower_label),
            new SettingsListField(Movies.NUMBER, R.string.details_number_label),
            new SettingsListField(Movies.DATE, R.string.details_date_label),
            new SettingsListField(Movies.DATE_WATCHED, R.string.details_datewatched_label),
            new SettingsListField(Movies.ORIGINAL_TITLE, R.string.details_originaltitle_label),
            new SettingsListField(Movies.TRANSLATED_TITLE, R.string.details_translatedtitle_label),
            new SettingsListField(Movies.SOURCE, R.string.details_source_label),
            new SettingsListField(Movies.MEDIA_TYPE, R.string.details_mediatype_label),
            new SettingsListField(Movies.VIDEO_FORMAT, R.string.details_videoformat_label),
            new SettingsListField(Movies.AUDIO_FORMAT, R.string.details_audioformat_label),
            new SettingsListField(Movies.RESOLUTION, R.string.details_resolution_label),
    };
